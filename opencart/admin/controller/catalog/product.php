...
// Add purchase action START					
					array(
						'text' => $this->language->get('text_purchase'),
						'href' => $this->url->link('catalog/product/purchase', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, 'SSL')
					)
// Add purchase action END					
			);
...
//Add by tupv : Purchase action START
...
//Add by tupv : Purchase action END			
	protected function getPurchaseForm() {
		$this->data['heading_title'] = $this->language->get('heading_title');
